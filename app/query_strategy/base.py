...
class QueryStrategyBase:
    def __init__(self, learning_model, each_cycle=10, *args, **kwargs):
        self.learning_model = learning_model
        self.features_vectorized_key = (
            self.learning_model.feature_extractor.features_vectorized_key
        )
    ...
    def update_training_set_features(self):
        self.learning_model.data.loc[
            self.learning_model.data.training_set == 1, self.features_vectorized_key
        ] = self.learning_model.data.loc[
